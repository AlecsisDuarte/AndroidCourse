package mx.com.omnius.twitterapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonConecar = (Button) findViewById(R.id.button_conectar);
        buttonEnviar = (Button) findViewById(R.id.button_enviar_tweet);
        editTweet = (EditText) findViewById(R.id.edit_tweet);
        imageView = (ImageView) findViewById(R.id.image_usuario);
