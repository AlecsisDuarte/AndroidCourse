package mx.com.omnius.facebookapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBoton = (LoginButton) findViewById(R.id.loginButton);
        imagenPerfil = (ProfilePictureView) findViewById(R.id.profilePicture);
        nombreUsuarioFB = (TextView) findViewById(R.id.greeting);
        publicarButton = (Button) findViewById(R.id.postStatusUpdateButton);
